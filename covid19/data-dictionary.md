...
| `province`                 |            0.991182 | `data/clean-outside-hubei.csv` |
| `country`                  |            1.000000 | `data/clean-hubei.csv`         |
| `country`                  |            0.998570 | `data/clean-outside-hubei.csv` |
| `latitude`                 |            1.000000 | `data/clean-hubei.csv`         |
| `latitude`                 |            0.975572 | `data/clean-outside-hubei.csv` |
| `longitude`                |            1.000000 | `data/clean-hubei.csv`         |
| `longitude`                |            0.975572 | `data/clean-outside-hubei.csv` |
| `geo_resolution`           |            1.000000 | `data/clean-hubei.csv`         |
| `geo_resolution`           |            0.975572 | `data/clean-outside-hubei.csv` |
| `date_onset_symptoms`      |            0.009373 | `data/clean-hubei.csv`         |
| `date_onset_symptoms`      |            0.057078 | `data/clean-outside-hubei.csv` |
| `date_admission_hospital`  |            0.004045 | `data/clean-hubei.csv`         |
| `date_admission_hospital`  |            0.062798 | `data/clean-outside-hubei.csv` |
| `date_confirmation`        |            0.918204 | `data/clean-hubei.csv`         |
| `date_confirmation`        |            0.989990 | `data/clean-outside-hubei.csv` |
| `symptoms`                 |            0.003848 | `data/clean-hubei.csv`         |
| `symptoms`                 |            0.037059 | `data/clean-outside-hubei.csv` |
| `lives_in_wuhan`           |            0.003848 | `data/clean-hubei.csv`         |
| `lives_in_wuhan`           |            0.053980 | `data/clean-outside-hubei.csv` |
| `travel_history_dates`     |            0.000000 | `data/clean-hubei.csv`         |
| `travel_history_dates`     |            0.046711 | `data/clean-outside-hubei.csv` |
...
| `reported_market_exposure` |            0.008937 | `data/clean-outside-hubei.csv` |
| `additional_information`   |            0.002171 | `data/clean-hubei.csv`         |
| `additional_information`   |            0.067803 | `data/clean-outside-hubei.csv` |
| `chronic_disease_binary`   |            0.002171 | `data/clean-hubei.csv`         |
| `chronic_disease_binary`   |            0.001787 | `data/clean-outside-hubei.csv` |
| `chronic_disease`          |            0.002072 | `data/clean-hubei.csv`         |
| `chronic_disease`          |            0.002026 | `data/clean-outside-hubei.csv` |
| `source`                   |            1.000000 | `data/clean-hubei.csv`         |
| `source`                   |            0.991778 | `data/clean-outside-hubei.csv` |
| `sequence_available`       |            0.000197 | `data/clean-hubei.csv`         |
| `sequence_available`       |            0.000119 | `data/clean-outside-hubei.csv` |
| `outcome`                  |            0.004144 | `data/clean-hubei.csv`         |
| `outcome`                  |            0.009295 | `data/clean-outside-hubei.csv` |
| `date_death_or_discharge`  |            0.004045 | `data/clean-hubei.csv`         |
| `date_death_or_discharge`  |            0.006316 | `data/clean-outside-hubei.csv` |
| `notes_for_discussion`     |            0.000000 | `data/clean-hubei.csv`         |
| `notes_for_discussion`     |            0.010129 | `data/clean-outside-hubei.csv` |
| `location`                 |            0.000000 | `data/clean-hubei.csv`         |
| `location`                 |            0.020138 | `data/clean-outside-hubei.csv` |
| `admin3`                   |            0.025555 | `data/clean-hubei.csv`         |
| `admin3`                   |            0.110582 | `data/clean-outside-hubei.csv` |
| `admin2`                   |            0.974544 | `data/clean-hubei.csv`         |
| `admin2`                   |            0.814228 | `data/clean-outside-hubei.csv` |
| `admin1`                   |            1.000000 | `data/clean-hubei.csv`         |
| `admin1`                   |            0.968065 | `data/clean-outside-hubei.csv` |
